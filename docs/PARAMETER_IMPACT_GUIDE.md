...
| 등급 | 승률 (Win Rate) | Profit Factor | MDD | 특징 |
|------|-----------------|---------------|-----|------|
| 🏆 **S등급** | ≥85% | ≥3.0 | ≤10% | 최상위 등급, 최소 리스크 |
| 🥇 **A등급** | ≥75% | ≥2.0 | ≤15% | 우수 등급, 균형잡힌 성능 |
| 🥈 **B등급** | ≥70% | ≥1.5 | ≤20% | 양호 등급, 수용 가능한 리스크 |
| 🥉 **C등급** | <70% | <1.5 | >20% | 기본 등급, 개선 필요 |
