"""
TwinStar Quantum - Single Optimizer Widget
==========================================

싱글 심볼 최적화 위젯

[마이그레이션 중] 현재는 GUI/optimization_widget.py의 
SingleOptimizerWidget을 래핑합니다.
...
try:
    ...
    logger.warning(f"⚠️ SingleOptimizerWidget import 실패: {e}")
